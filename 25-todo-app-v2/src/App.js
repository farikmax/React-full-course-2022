...
function App() {
	...
	return (
		<div className="App">
			...
			{!!todos.length && <TodosActions completedTodosExist={!!completedTodosCount} resetTodos={resetTodoHandlers} deleteCompletedTodos={deleteCompletedTodosHandler} />}
